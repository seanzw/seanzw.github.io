...
\newcommand{\contact}[4]{
	\begin{changemargin}{-0.5in}{-0.5in}
		\begin{center}
			...
			Room 931, Ho Sin-Hang Engineering Building, CUHK, Shating, N.T., Hong Kong SAR, PRC\\ \smallskip
			{\href{#2}{#2}} ~ \smallskip 
			{\href{#3}{#3}} ~
...
\begin{document}
\contact{Zhengrong Wang}{zhengrongwang@cuhk.edu.hk}{https://seanzw.github.io}{https://scholar.google.com/citations?user=h\_GwGfQAAAAJ\&hl=en}
...
% 	\indent
% 	My open source work has been accepted by
...
% ------
	\textbf{Assistant Professor}, \emph{Department of Computer Science and Engineering} \hfill Hong Kong SAR, China \\
The Chinese University of Hong Kong \hfill \emph{Aug. 25th 2025 - Now} {} \\

\vspace{6pt}

	\textbf{Research Scientist} \hfill Shenzhen, China \\
HiSilicon \hfill \emph{Aug. 25th 2024 - Aug. 24th 2025} {} \\

\vspace{6pt}
	\textbf{Postdoctoral Scholar}, \emph{Department of Computer Science} \hfill Los Angeles, USA \\
University of California, Los Angeles \hfill \emph{Jan. 1st 2024 - Aug.24th. 2024}{} \\
...
Ph.D. in Computer Science, Advisor: Tony Nowatzki \hfill \emph{Aug. 2018 - Dec. 2023} {} \\
...
\header{Publication - Top 5 Most Representative within 5 Years}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Skills
\header{Publication - 5 Representative Beyond Recent 5 Years}

\begin{body}
	\vspace{14pt}
	PIMSAB: A Processing-In-Memory System with Spatially-Aware Communication and Bit-Serial-Aware Computation\\
	Siyuan Ma, Kaustubh Mhatre, Jian Weng, Bagus Hanindhito, \textbf{Zhengrong Wang (5th/8)}, Tony Nowatzki, Lizy John, Aman Arora\\
	\emph{2024 ACM Transactions on Architecture and Code Optimization (TACO)}.\\
	\vspace{6pt}

	SPGPU: Spatially Programmed GPU\\
	Shizhuo Zhu, Illia Shkirko, Jacob Levinson, \textbf{Zhengrong Wang (4th/5)}, Tony Nowatzki\\
	\emph{2024 IEEE Computer Architecture Letters (CAL)}.\\
	\vspace{6pt}
	\newpage

	% -----
	OverGen: Improving FPGA Usability through Domain-specific Overlay Generation\\
	Sihao Liu, Jian Weng, Dylan Kupsh, Atefeh Sohrabizadeh, \textbf{Zhengrong Wang (5th/11)}, Licheng Guo, Jiuyang Liu, Maxim Zhulin, Lucheng Zhang, Jason Cong, Tony Nowatzki \\
	\emph{IEEE/ACM International Symposium on Microarchitecture (MICRO)}, 2022, Chicago, USA.\\
	\textbf{Best Paper Runner-Up} \\
	\vspace{6pt}
	% -----
	DSAGEN: Synthesizing Programmable Spatial Accelerators \\
	Jian Weng, Sihao Liu, Vidushi Dadu, \textbf{Zhengrong Wang (4th/6)}, Preyas Shah, Tony Nowatzki \\
	...
	Jian Weng, Sihao Liu, \textbf{Zhengrong Wang (3rd/5)}, Vidush Dadu, Tony Nowatzki \\
...
% -----
	\textbf{Stream-Specialized Near-Data Acceleration Framework} \href{https://github.com/PolyArch/gem-forge-framework}{\ExternalLink} \hfill \emph{Jan. 2018 - Now}\\
...
% -----
	\textbf{Gem5-AVX} \href{https://github.com/seanzw/gem5-avx}{\ExternalLink} \hfill \emph{Jan. 2019 - Now}\\
	First Author \& Maintainer \\
	\begin{itemize}
	\itemsep 0pt
...
% -----
	...
	\textbf{Gem5 Simulator} \href{https://github.com/gem5/gem5}{\ExternalLink} \hfill \emph{Jan. 2019 - Now}\\
...
% \begin{body}
% 	\vspace{14pt}
% 	\textbf{HiSilicon} \hfill \emph{Aug. 2024 - Now} \\
% 	System Engineer
% 	\begin{itemize}
% 	\itemsep 0pt
% 	\item Work on next-gen AI chip.
% 	\end{itemize}
% 	\smallskip
...
% 	Develop the compiler support for Infinity Stream (Published in ASPLOS '23)	\hfill \emph{Dec. 2021 - Now} \\
% 	\smallskip
